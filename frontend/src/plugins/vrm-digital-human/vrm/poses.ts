...
const POSE_PRESETS: Record<string, BoneRotation[]> = {
  ...
  coding: [
    { bone: VRMHumanBoneName.LeftUpperArm, x: 31, y: -71, z: -30 },
    { bone: VRMHumanBoneName.LeftLowerArm, x: -2, y: -35, z: 26 },
    { bone: VRMHumanBoneName.LeftHand, x: 30 },
    { bone: VRMHumanBoneName.LeftThumbMetacarpal, x: 14, y: 13, z: 10 },
    { bone: VRMHumanBoneName.LeftThumbProximal, z: -2 },
    { bone: VRMHumanBoneName.LeftThumbDistal, x: 8, y: 33, z: -19 },
    { bone: VRMHumanBoneName.LeftIndexProximal, z: 10 },
    { bone: VRMHumanBoneName.LeftIndexIntermediate, z: -15 },
    { bone: VRMHumanBoneName.LeftIndexDistal, z: -1 },
    { bone: VRMHumanBoneName.LeftMiddleProximal, z: 10 },
    { bone: VRMHumanBoneName.LeftMiddleIntermediate, z: -15 },
    { bone: VRMHumanBoneName.LeftMiddleDistal, z: -2 },
    { bone: VRMHumanBoneName.LeftRingProximal, z: 10 },
    { bone: VRMHumanBoneName.LeftRingIntermediate, z: -15 },
    { bone: VRMHumanBoneName.LeftRingDistal, z: -2 },
    { bone: VRMHumanBoneName.LeftLittleProximal, z: 10 },
    { bone: VRMHumanBoneName.LeftLittleIntermediate, z: -15 },
    { bone: VRMHumanBoneName.LeftLittleDistal, z: -2 },
    { bone: VRMHumanBoneName.RightUpperArm, x: 31, y: 71, z: 30 },
    { bone: VRMHumanBoneName.RightLowerArm, x: 2, y: 35, z: -26 },
    { bone: VRMHumanBoneName.RightHand, x: 30 },
    { bone: VRMHumanBoneName.RightThumbMetacarpal, x: -14, y: -13, z: -10 },
    { bone: VRMHumanBoneName.RightThumbProximal, z: 2 },
    { bone: VRMHumanBoneName.RightThumbDistal, x: -8, y: -33, z: 19 },
    { bone: VRMHumanBoneName.RightIndexProximal, z: -10 },
    { bone: VRMHumanBoneName.RightIndexIntermediate, z: 15 },
    { bone: VRMHumanBoneName.RightIndexDistal, z: 2 },
    { bone: VRMHumanBoneName.RightMiddleProximal, z: -10 },
    { bone: VRMHumanBoneName.RightMiddleIntermediate, z: 15 },
    { bone: VRMHumanBoneName.RightMiddleDistal, z: 2 },
    { bone: VRMHumanBoneName.RightRingProximal, z: -10 },
    { bone: VRMHumanBoneName.RightRingIntermediate, z: 15 },
    { bone: VRMHumanBoneName.RightRingDistal, z: 2 },
    { bone: VRMHumanBoneName.RightLittleProximal, z: -10 },
    { bone: VRMHumanBoneName.RightLittleIntermediate, z: 15 },
    { bone: VRMHumanBoneName.RightLittleDistal, z: 2 },
    { bone: VRMHumanBoneName.Head, z: 5 },
    { bone: VRMHumanBoneName.LeftUpperLeg, x: -52 },
    { bone: VRMHumanBoneName.LeftLowerLeg, x: 53 },
    { bone: VRMHumanBoneName.RightUpperLeg, x: -62 },
    { bone: VRMHumanBoneName.RightLowerLeg, x: 70 },
  ],
